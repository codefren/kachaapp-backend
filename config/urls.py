...
urlpatterns = [
    ...
    # User management
    path("users/", include("kachadigitalbcn.users.urls", namespace="users")),
...
# API URLS
from market.views import MarketProximityTokenObtainPairView, MarketProximityTokenRefreshView
urlpatterns += [
    # API base url
